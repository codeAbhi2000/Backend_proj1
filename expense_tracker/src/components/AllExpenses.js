            ...
            <TableBody>
              {filterData.filter ? (
                Expenses.filter((m) => {
                  ...
                  if (parseInt(cdate) === filterData.filter) {
                    ...
                    parseInt(m.date.slice(0, 4)) === filterData.filter
                  ) {
                    return m;
                  }
                })
                  ...
                  .map((e) => (
                    <TableRow key={e._id}>
                      ...
                      <TableCell align="center">
                        <IconButton onClick={() => clickedItemdata(e)}>
                          <EditIcon />
                        </IconButton>
                      </TableCell>
                    </TableRow>
              ...
              {filterData.searchKey ? (
                Expenses.filter((m) => {
                  return m.cat_name
                    .toLowerCase()
                    .includes(filterData.searchKey.toLowerCase());
                })
                  .slice(page * rowPerPage, page * rowPerPage + rowPerPage)
                  .map((e) => (
                    <TableRow key={e._id}>
            ...
            <form onSubmit={handleSubmit}>
              <Stack spacing={1}>
                ...
                >
                  ...
                  <MenuItem value={"bills_utilities"}>
                    Bills & Utilities
                  </MenuItem>
